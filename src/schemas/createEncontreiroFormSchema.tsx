...
const createEncontreiroFormSchema = z
  .object({
    fullName: z
      .string()
    ...
    instagram: z.string().min(1, { message: 'Digite o nome de usuário' }),
    whatsapp: z.string().min(1, { message: 'Informe seu contato do whatsapp' }),
    church: z
      .object(selectObject, {
    ...
    zipCode: z.string().min(8, { message: 'Informe o seu CEP' }),
    address: z
      .string()
    ...
    badgeName: z
      .string()
      .min(1, { message: 'Digite o nome que irá no seu crachá' }),
