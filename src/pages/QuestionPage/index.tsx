  ...
  return (
    <main className="mt-48 max-sm:mt-24 flex flex-col items-center ">
      <div className="flex justify-center">
        ...
        >
          Você já participou de algum Encontro de Jovens com Cristo (EJC)
          pela igreja católica anteriormente?
        </h1>
      </div>
      <div className="flex max-sm:flex-col max-sm:items-center gap-4 mt-14 mb-12">
        ...
        >
          ...
          />
          <div>
            {isCheckedEncontreiro
              ? (<img src={ checkRedCircle } alt="" />)
              : ''}
          </div>
